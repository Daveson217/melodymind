...
# --- CONFIG ---
GENIUS_TOKEN = os.getenv("GENIUS_ACCESS_TOKEN")  # Add to env
...
def generate_batch_quiz(num_questions=15):
    """Generates a mix of Normal (80%) and Hard (20%) questions."""
    questions = []

    # Try to fetch contexts
    all_docs = collection.get(
        limit=50, include=["documents", "metadatas", "embeddings"])
    ...
    for i in range(num_questions):
        ...
        if is_hard:
            ...
            # Find distractors (simulated for speed, query DB in full prod)
